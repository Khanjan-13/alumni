        ...
        <main className="p-6">
          ...
          <div className="grid gap-6 mt-6 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>
                  Monthly engagement metrics for the past year
                </CardDescription>
              </CardHeader>
            ...
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>
                  Latest alumni who joined the portal
                </CardDescription>
              </CardHeader>
              <CardContent>{/* <RecentAlumni /> */}</CardContent>
            </Card>
          </div>
          ...
          <div className="mt-6">
            <Card>
              ...
              <CardContent>{/* <UpcomingEvents /> */}</CardContent>
            </Card>
          </div>
        </main>
      </div>
